...
```
$ git clone https://github.com/sz/.tmux.git "/path/to/oh-my-tmux"
...
```
$ git clone https://github.com/kratocz/.tmux.git "/path/to/oh-my-tmux"
$ mkdir -p "~/.config/tmux"
...
[my own Vim configuration]: https://github.com/kratocz/.vim.git
